...
int main() {
    ...
    startSpheres[1].color[0] = 1;
    startSpheres[1].color[1] = 0;
    startSpheres[1].color[2] = 0;
    startSpheres[1].specularColor[0] = 1;
    startSpheres[1].specularColor[1] = 1;
    startSpheres[1].specularColor[2] = 1;
    startSpheres[1].radius = 1;
    startSpheres[1].emissionStrength = 0;
    startSpheres[1].smoothness = 1;
    startSpheres[1].specularProbability = 0.2;
